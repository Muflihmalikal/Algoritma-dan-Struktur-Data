...
public class DemoArrayList {
    public static void main(String[] args) {
        ...
        System.out.println("Index of Budi: " + customers.indexOf(customer2));

        Customer customer = customers.get(1);
        System.out.println("Nama sebelum diubah: " + customer.name);
        ...
        System.out.println("Data List: " + customers);
    }
}